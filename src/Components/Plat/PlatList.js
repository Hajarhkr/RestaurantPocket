                                    ...
                                    {plats.length === 0 ?
                                        ...
                                        currentPlats.map((plat) => (
                                            <tr key={plat.idrepas}>
                                                ...
                                                <td>
                                                    <ButtonGroup>
                                                        <Link to={"edit/" + plat.idrepas} className="btn btn-sm btn-outline-primary"><FontAwesomeIcon icon={faEdit} /></Link>
                                                        <Button size="sm" variant="outline-danger" onClick={this.deletePlat.bind(this, plat.idrepas)}><FontAwesomeIcon icon={faTrash} /></Button>
                                                    </ButtonGroup>
                                                </td>
                                            </tr>
                                        ))
